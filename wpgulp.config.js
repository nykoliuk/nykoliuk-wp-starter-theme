...
module.exports = {
	...
	// Project options.
	projectURL: 'dev.nokan', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	...
	// Translation options.
	textDomain: 'nykoliuk', // Your textdomain here.
	translationFile: 'nykoliuk.pot', // Name of the translation file.
	translationDestination: './languages', // Where to save the translation files.
	packageName: 'nykoliuk', // Package name.
	bugReport: '', // Where can users report bugs.
	lastTranslator: 'Nykoliuk <misha.nykoliuk@gmail.com>', // Last translator Email ID.
	team: 'Nykoliuk <misha.nykoliuk@gmail.com>', // Team's Email ID.
